      ...
      <Dialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
        <DialogContent className="max-w-md bg-card">
          <DialogHeader>
            ...
            <DialogDescription>Chọn tuần cuối. Tất cả tuần từ tuần hiện tại đến tuần này sẽ nằm trong cùng một link chỉ xem và tự động xoá sau 24 giờ.</DialogDescription>
          </DialogHeader>
