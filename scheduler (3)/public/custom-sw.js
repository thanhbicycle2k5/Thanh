const APP_SHELL_CACHE = 'task2goal-app-shell-v3';
...
const APP_SHELL_URLS = ['/', '/index.html', '/task2goal-icon-new.jpg', '/task2goal-icon-cropped.svg', '/task2goal-splash.jpg', '/task2goal-splash-cropped.svg', '/manifest.webmanifest'];
...
function showNotification(payload) {
  return self.registration.showNotification(payload.title, {
    ...
    tag: payload.id,
    renotify: false,
    icon: '/task2goal-icon-cropped.svg',
    badge: '/task2goal-icon-cropped.svg',
    data: payload,
  });
}
